...
def _compute_joint_entropy(
    ...
    Computes the exact joint entropy using the **entropy semiring**
    technique applied to a backward composition DP.
    ...
    Complexity: O(D × N × max_k). Only needs the backward pass
